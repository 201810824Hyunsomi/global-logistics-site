...
var Claim = require('../models/board/Claim');
var Like=require('../models/board/Like');
...
// claim
router.post('/claim', util.isLoggedin, checkPostId, function(req, res){ 
...
router.post('/clicks', util.isLoggedin, function(req,res) {
